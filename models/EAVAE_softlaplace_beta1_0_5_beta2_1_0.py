...
# Your trained models
# ...
#checkpoint_path = os.path.join(root, 'experiments/EAVAE_softlaplace_beta1_0_5_beta2_1_0/2026-06-07__02-41/checkpoints/checkpoint_5000.pth')
log_params = Hyperparams(
    name='EAVAE_softlaplace_beta1_0_5_beta2_1_0',
...
model_params = Hyperparams(
    ...
    model_name='EAVAE_softlaplace_beta1_0_5_beta2_1_0',
    model_type='eavae',
)
...
loss_params = Hyperparams(
    ...
    vae_beta_max = 0.5,             # latent z ending beta
    contrast_beta_start=10.0,   # latent s starting beta
    contrast_beta_end=1,     # latent s ending beta
